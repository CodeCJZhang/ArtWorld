...
- (CGFloat)heightForContentBreakView
{
    ...
    NSLog(@"self.scrollViewOriginalInset.bottom:%f",self.scrollViewOriginalInset.bottom );
    NSLog(@"- self.scrollViewOriginalInset.top:%f",self.scrollViewOriginalInset.top);
    
    CGFloat h = self.scrollView.frame.size.height - self.scrollViewOriginalInset.bottom - self.scrollViewOriginalInset.top;
    NSLog(@"h:%lf",h);
    NSLog(@"self.scrollView.contentSize.height:%f",self.scrollView.contentSize.height);
    NSLog(@"self.scrollView.contentSize.height - h:%f",self.scrollView.contentSize.height - h);
