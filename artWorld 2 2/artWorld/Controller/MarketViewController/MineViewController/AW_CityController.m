...
@interface AW_CityController ()<UITableViewDataSource,UITableViewDelegate>
/**
...
@implementation AW_CityController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [_delegate didClickedCityCell:self.provinceModal city:modal];
