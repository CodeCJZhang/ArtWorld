...
#import "AW_ProvinceController.h"
#import "AW_Constants.h"
#import "AW_ProvncesCell.h"
#import "AW_ProvinceModal.h"
#import "AFNetworking.h"
#import "AW_CityController.h"

@interface AW_ProvinceController ()<UITableViewDataSource,UITableViewDelegate>
/**
...
@implementation AW_ProvinceController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(nonnull NSIndexPath *)indexPath{
    AW_ProvinceModal * modal = self.provinceArray[indexPath.row];
    AW_CityController * controller = [[AW_CityController alloc]init];
